        ...
        implements Serializable
{
    ...
    public Table minus (Table table2)
    {
        ...
        //returns members of this table as a set, parses through
        for (var tuple: this.index.keySet()) {
            //if the tuple is not in table two, then add to this table
            if(!table2.index.containsKey(tuple)){
                rows.add(this.index.get(tuple));
            }//if
        }//for
